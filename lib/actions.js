...
function forEachFiberSetCost(fiber){
  ...
  var nearestPoint = geolib.findNearest(store.selectedPosition, fiber.geometry.coordinates, 1)
  console.log("neareset point: ", nearestPoint)
  fiber.distance = geolib.getDistance(store.selectedPosition, nearestPoint)
